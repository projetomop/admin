            ...
            <div class="card-header">
                ...
                <div class="card-tools float-left">
                    <div class="input-group input-group-sm ml-3">
                        <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#cadService-">
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu p-1" role="menu">
                                        <a class="dropdown-item bg-danger mb-1" href="#">Editar</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              @include('service.forms.service_form')
            </div>
